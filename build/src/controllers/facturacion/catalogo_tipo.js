...
const getRegistros = (__, resp = response) => __awaiter(void 0, void 0, void 0, function* () {
    const registros = yield prisma.catalogoTipo.findMany({
        where: { estado: "ACTIVO" },
    });
...
const getRegistro = (req = request, resp = response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const registros = yield prisma.catalogoTipo.findFirst({
...
const crearRegistro = (req = request, resp = response) => __awaiter(void 0, void 0, void 0, function* () {
    let { nombre = "" } = req.body;
    try {
        const data = yield prisma.catalogoTipo.create({
            data: {
                nombre
            },
        });
...
const actualizarRegistro = (req = request, resp = response) => __awaiter(void 0, void 0, void 0, function* () {
    let uid = Number(req.params.id);
    try {
        const registro = yield prisma.catalogoTipo.findFirst({
            where: { id_tipo: uid, estado: "ACTIVO" },
        });
        if (!registro) {
        ...
        let { nombre = "" } = req.body;
        const registroActualizado = yield prisma.catalogoTipo.update({
            where: { id_tipo: uid },
            data: { nombre },
        });
        resp.json({
...
const eliminarRegistro = (req = request, resp = response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield prisma.catalogoTipo.update({
