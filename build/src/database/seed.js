...
const execute = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield prisma.facturasTipos.createMany({
            data: [
                { id_tipo_factura: 1, nombre: "Consumidor Final" },
                { id_tipo_factura: 2, nombre: "Credito Fiscal" },
            ],
        });
        yield prisma.facturasMetodosDePago.createMany({
            data: [
                { nombre: "Efectivo" },
                { nombre: "Tarjeta" },
                { nombre: "Cheque" },
        ...
        yield prisma.departamentos.createMany({
            data: [
        ...
        yield prisma.municipios.createMany({
            data: [
        ...
        yield prisma.catalogoCategorias.createMany({
            data: [{ nombre: "Categoria 1" }, { nombre: "Categoria 2" }],
        });
        yield prisma.catalogoTipo.createMany({
            data: [{ nombre: "Servicio" }, { nombre: "Producto" }],
        });
        //SUCURSAL DEMO
        let sucursal = yield prisma.sucursales.create({
            data: {
                nombre: "Sucursal Matriz",
            },
        });
        //ROLS DEMO
        let rol = yield prisma.roles.create({
            data: {
                nombre: "Rol 1",
            },
        });
        ...
        yield prisma.generalData.create({
            data: {
